...
import type { InputNumberBoxEvent, SkuPopupEvent } from '@/components/vk-data-goods-sku-popup/vk-data-goods-sku-popup';
    ...
    <template v-if="memberStore.profile">
      ...
      <view class="toolbar">
        ...
        <view class="button-grounp">
          <view class="button payment-button" @tap="gotoPayment" :class="{ disabled: selectedCartListCount <=0 }"> 去结算({{ selectedCartListCount }}) </view>
        </view>
      </view>
    </template>
    <!-- 未登录: 提示登录 -->
